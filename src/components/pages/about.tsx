    ...
    return (
        <div className="w-full text-white min-h-screen " id="about" ref={ref}>
            <div className="min-h-screen w-full flex flex-col sm:flex-row justify-center items-center">
                <div className="backdrop-blur-[2px] mt-[4rem] sm:mt-0 sm:ml-4 gap-y-8 sm:gap-y-0 lg:backdrop-blur-[1px] w-full px-5 lg:pl-24 lg:pr-24 xl:pl-32 pb-16 sm:pb-0 flex min-h-screen flex-col sm:flex-row justify-center items-center gap-x-12">
